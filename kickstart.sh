...
$CAFFE_ROOT/build/tools/caffe train -solver $DOG_VS_CAT_FOLDER/dnn_solver.prototxt -weights $CAFFE_ROOT/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel
